...
# ПРАВИЛО 72 ГОДИН
# ─────────────────────────────────────────────
MAX_RESOLUTION_HOURS: int = 72          # Тільки ринки з вирішенням < 72 год
MIN_MARKET_VOLUME_USD: float = 5_000.0  # Мінімальна ліквідність ринку
...
# ─────────────────────────────────────────────
MM_MODE: bool = False              # Market Making режим (вимкнений за замовчуванням)
